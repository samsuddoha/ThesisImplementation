...
public class ModelFitness {
	...
	public static void main(String[] args) {
		...
		model_similarity_reliability.add(new double[]{1, 0.5, 0.75});
		model_similarity_reliability.add(new double[]{2, 0.5, 0.88});
		model_similarity_reliability.add(new double[]{3, 0.75, 0.78});
		model_similarity_reliability.add(new double[]{2, 0.75, 0.92});
		model_similarity_reliability.add(new double[]{1, 0.5, 0.85});
		model_similarity_reliability.add(new double[]{3, 0.75, 0.65});
		model_similarity_reliability.add(new double[]{2, 0.75, 0.67});
